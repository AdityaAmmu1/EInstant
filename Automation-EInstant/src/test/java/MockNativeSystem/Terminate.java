...
public void Auto() throws FindFailed, InterruptedException, AWTException{
    ...
    Thread.sleep(2000);
 	...
 	driver.findElement(By.xpath("//*[@id=\"Sessions\"]/span[2]")).click();// Select Sessions & Transactions
 	Thread.sleep(3000);
 	driver.findElement(By.xpath("//*[@id=\"ui-panel-1-content\"]/div/div[3]/search-condition-operator-section/div[1]/div[1]/p-dropdown/div/div[3]/span")).click();
 	driver.findElement(By.xpath("//*[@id=\"ui-panel-1-content\"]/div/div[3]/search-condition-operator-section/div[1]/div[1]/p-dropdown/div/div[4]/div[1]/input")).sendKeys("Georgia Lottery"+Keys.ARROW_DOWN+Keys.ENTER); //Select on GE lottery
 	Thread.sleep(2000);
 	driver.findElement(By.xpath("//*[@id=\"ui-panel-1-content\"]/div/div[3]/search-condition-operator-section/div[1]/div[2]/p-dropdown/div/label")).click(); //
 	Thread.sleep(2000);
 	driver.findElement(By.xpath("//*[@id=\"ui-panel-1-content\"]/div/div[3]/search-condition-operator-section/div[1]/div[2]/p-dropdown/div/div[4]/div[1]/input")).sendKeys("GA SIT2"+Keys.DOWN+Keys.ENTER);
 	Thread.sleep(2000);
 	driver.findElement(By.xpath("//*[@id=\"ui-panel-1-content\"]/div/div[4]/button[2]/span")).click();
 	Thread.sleep(2000);
 	driver.findElement(By.cssSelector("#ui-tabpanel-0 > div.pagination-table-div > div > p-table > div > div.ui-table-scrollable-wrapper.ng-star-inserted > div > div.ui-table-scrollable-body > table > tbody > tr:nth-child(1) > td:nth-child(4) > label")).click(); //select on the latest session
 	Thread.sleep(2000);
 	driver.findElement(By.xpath("//*[@id=\"ui-tabpanel-0\"]/div[1]/div[1]/app-player-session/div/button/span")).click(); //click on terminate Apply on RGS page
 	Thread.sleep(1000);
 	driver.findElement(By.xpath("//*[@id=\"ui-tabpanel-0\"]/div[1]/div[1]/app-player-session/div/p-dialog/div/div[3]/p-footer/button[1]/span")).click(); //click on terminate on the pop-up
 	Thread.sleep(2000);
 	driver.findElement(By.xpath("//*[@id=\"ui-tabpanel-0\"]/div[1]/p-dialog/div/div[3]/p-footer/div/button/span")).click(); //click on close
 	Thread.sleep(2000);
